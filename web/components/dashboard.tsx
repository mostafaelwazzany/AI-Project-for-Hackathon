...
export default function AnalysisDashboard() {
  ...
  return <div className="min-h-screen">
    ...
    <main className="mx-auto max-w-[1440px] space-y-6 px-4 py-8 sm:px-8 sm:py-10">
      <section className="flex flex-col justify-between gap-5 md:flex-row md:items-end"><div><div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-[.18em] text-[#5ba7ff]"><ShieldCheck aria-hidden="true" size={15} /> Verified baseline</div><h1 className="mt-3 text-3xl font-semibold sm:text-4xl">Complete RAG evaluation</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-[#8ca6c1]">Saved k=5 baseline, language coverage, model and chunk experiments, plus a safe temporary Top-k runner.</p></div><div className="rounded-xl border border-[#2b805f] bg-[#0a2826] px-4 py-3 text-sm text-[#71e5b9]">Production configuration remains k=5</div></section>
      ...
      <Section title="Temporary Top-k evaluation" description="Choose any k from 1 to 20. The experiment is displayed here only and does not overwrite the saved report or config.TOP_K = 5.">
